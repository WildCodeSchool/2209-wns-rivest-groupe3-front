    ...
    <section className="flex justify-between items-center flex-row w-full my-10">
      <aside className="w-1/5">
        <h1>
          ...
          blanditiis inventore expedita harum labore illum nostrum laboriosam
          debitis, quas non aperiam quis accusantium doloribus nihil magni saepe
          cupiditate assumenda voluptates?
        </h1>
      </aside>
